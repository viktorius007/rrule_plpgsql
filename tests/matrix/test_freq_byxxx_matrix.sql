...
SELECT assert_true('YEARLY+BYWEEKNO+BYYEARDAY',
    (SELECT COUNT(*) >= 0 FROM rrule."all"('FREQ=YEARLY;BYWEEKNO=10;BYYEARDAY=65,66,67;COUNT=100', '2025-01-01 10:00:00'::TIMESTAMP)));
...
SELECT assert_true('DAILY+complex-intersection',
    (SELECT COUNT(*) >= 0 FROM rrule."all"('FREQ=DAILY;BYDAY=FR;BYMONTH=1;BYMONTHDAY=13;COUNT=10', '2025-01-01 10:00:00'::TIMESTAMP)));
